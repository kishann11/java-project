<%@page contentType="text/html"%>
 ...
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  { 	String driverClassName = "com.mysql.jdbc.Driver";//JDBC and Relational Databases forum at Coderanch
	...
	String us = "root";
	String password = "123";// your password
	String query = null;
	query = "select * from detail Where " + "actor = ?";
	Connection con = DriverManager.getConnection(url,
	us, password);
	if(con==null){System.out.println("sorry");}
	//conn.close();
  /* Passing argument through the question mark */
  PreparedStatement ps=con.prepareStatement(query) ;
	  ps.setString(1,u); 
	 ResultSet resultSet = ps.executeQuery(); /*Set the Update query command */ 
	  //System.out.println("got username"+u);
...
con.close(); } 
  ...
  <a href="searchactor.jsp">Search Another Actor</a>
